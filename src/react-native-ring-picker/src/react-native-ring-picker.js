...
import DoubleSpin from "../../DoubleSpin";
...
let participantsHalf = ["Fruit", "Sport", "Animal", "Clothese"]

const weightHalf = [3, 5, 8, 4];
...
export default class ReactNativeRingPicker extends React.Component {
    ...
    render() {
        ...
        const wheelOptions = {
            ...
            rewardsHalf: participantsHalf,
            weightHalf: weightHalf,
            knobSize: 10,
            borderWidth: 5,
            borderColor: '#fff',
            innerRadius: 30,
